...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","BRONZE PACKAGE", "GOA","6 days and 7 Nights", "Airport Assistance at Aiport", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Cruise", "English Speaking Guide", "Summer Special", "Rs 12000 only"};
      String[] package2 = new String[]{"package2.jpg","SILVER PACKAGE", "LADAKH","4 days and 3 Nights", "Toll Free and Entrance Free Tickets", "Meet and Greet at Aiport", "Welcome drinks on Arrival", "Night Safari", "Full 3 Day Expedition  ", "Cruise with Dinner", "Winter Special", "Rs 25000 only"};
      String[] package3 = new String[]{"package3.jpg","GOLD PACKAGE ", "ALAPPUZHA","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "Winter Special", "Rs 32000 only"};
